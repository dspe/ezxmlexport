...
{* DESIGN: Control bar START *}<div class="box-bc"><div class="box-ml"><div class="box-mr"><div class="box-tc"><div class="box-bl"><div class="box-br">
    ...
    <div class="block">
        <input class="button" type="button" value="{'Show content that will be exported'|i18n( 'design/admin/xmlexport' )}" name="TextContentListExportButton" onclick="javascript:window.location ={concat('ezxmlexport/test/contentlist/', $export.id)|ezurl( 'single', 'full' )}"/>
        {*<input class="button" type="button" value="{'Realtime export'|i18n( 'design/admin/xmlexport' )}" name="TestRealTimeExportButton"onclick="javascript:window.location ={concat('ezxmlexport/test/realtime/', $export.id)|ezurl( 'single', 'full' )}"/>*}
        <input class="button" type="button" value="{'Back to this export channel'|i18n( 'design/admin/xmlexport' )}" name="TextContentBackCutomerButton" onclick="javascript:window.location ={concat('ezxmlexport/view/customer/', $export.customer_id)|ezurl( 'single', 'full' )}"/>
    </div>
