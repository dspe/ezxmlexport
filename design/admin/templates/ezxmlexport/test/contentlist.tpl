...
<div>
    ...
    {include name            = navigator
             ...
             page_uri        = concat('ezxmlexport/test/contentlist/', $export_id)
...
{* DESIGN: Control bar START *}<div class="box-bc"><div class="box-ml"><div class="box-mr"><div class="box-tc"><div class="box-bl"><div class="box-br">
    ...
    <div class="block">
        <input class="button" type="button" value="{'Back to export'|i18n( 'design/admin/xmlexport' )}" name="BackToExportButton"onclick="javascript:window.location ={concat( 'ezxmlexport/view/export/', $export_id )|ezurl( 'single', 'full' )}"/>
    </div>
