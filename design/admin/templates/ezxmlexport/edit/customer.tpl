...
{def $formAction = 'ezxmlexport/edit/'}
...
<div class="context-attributes">
    <form id="xmlexportaddcustomer" action="{$formAction|ezurl('no', 'full')}" method="post" enctype="multipart/form-data">
        ...
        {include uri="design:ezxmlexport/ftpfield.tpl"}
        ...
        <input type="button" name="CancelCustomerButton" value="{'Cancel'|i18n('design/admin/class/edit')}" class="button" onclick="javascript:window.location = {'ezxmlexport/menu/'|ezurl( 'single', 'full' )}"/>
    </form>
