...
if( $Type == 'customer' )
{
    ...
    if( $Module->isCurrentAction( 'PublishCustomer' ) )
    {
        ...
        if( $canPublish )
        {
            ...
            $Module->redirectTo( 'ezxmlexport/view/customer/' . $eZXMLExportCustomer->attribute( 'id' ) );
            return;
        }
    }
...
if( $Type == 'export' )
{
    ...
    if( $Module->isCurrentAction( 'BrowseForNodes' ) )
    {
        ...
        $fromCancelPagePrefix = 'ezxmlexport/edit/(type)/export';
        $fromCancelPage       = '';
    ...
    if( $Module->isCurrentAction( 'PublishExport' ) )
    {
        ...
        if( $canPublish )
        {
            ...
            $Module->redirectTo( 'ezxmlexport/view/customer/' . $CustomerID );
            return;
        }
    }
...
$Result = array();
$Result ['content'] = $tpl->fetch( 'design:ezxmlexport/edit/' . $templateName . '.tpl' );
